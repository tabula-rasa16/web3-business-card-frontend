<template>
  <div class="create-card-container">
    ...
    >
      ...
      <el-form-item>
        <el-button type="primary" @click="submitForm(formRef)">创建名片</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
import { getSocialMedia, createBusinessCard } from '../api/businessCard'
import { getSupportedChains, getWalletTokens, getWalletNfts, batchCreateAssets, batchUpdateAssets } from '../api/digitalAsset'
    ...
    if (valid) {
      try {
        ...
        if (selectedAssets.length) {
          ...
          await batchCreateAssets({ asset_list: assetList })
        }
